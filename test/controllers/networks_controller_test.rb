...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { coverage: @network.coverage, name: @network.name, user_id: @network.user_id } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { coverage: @network.coverage, name: @network.name, user_id: @network.user_id } }
